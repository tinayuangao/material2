...
import {AfterViewInit, Component, Directive, ElementRef, ViewContainerRef,
      ViewEncapsulation, Input, ChangeDetectionStrategy, TemplateRef, ViewChild} from '@angular/core';
